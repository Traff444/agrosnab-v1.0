...
- `src/components/Footer.tsx`: футер из 4 колонок (бренд, навигация, контакты, реквизиты). Контакты содержат ссылку на Telegram-бота и телефон, реквизиты — ООО «ТОПХИТ» с ИНН/КПП/юр. адресом.
...
- Подзаголовок Hero (desktop): «ТопХит дистрибьютор натурального растительного сырья из Аргентины, Индии, Крыма и РФ».
...
- В нижней полосе футера под копирайтом добавлена подпись с активной ссылкой на разработчиков: «Сайт разработан командой FanTeam.pro».
